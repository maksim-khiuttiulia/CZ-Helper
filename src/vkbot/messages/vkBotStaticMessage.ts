...
export const VK_OUT_MVCR_FUNCTIONS : VkBotStaticMessage = {
    message : "Вот что я умею:\n" +
        "\"Добби сова: ФАМИЛИЯ ИМЯ\" - проверка писем из минестерства магии\n" +
        "\"Добби хогвартс: XXXXYYYYMMDDZZZZ\" - состояние билета в Хогвартс\n" +
        "\"Добби хогсмит: OAM-XXXXX-XX\\CC-YYYY\" - состояние билета в Хогсмит\n",
